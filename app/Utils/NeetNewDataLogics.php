        ...
        foreach ($roll_no_arr as $roll_nos){
            ...
            for ($i=0; $i<count($QuestionsNos); $i++){
                ...
                if ($i === count($QuestionsNos) -1){
                    if($student_ans === "ABSENT"){
                        $users_answer  =  $users_answer.'AB';
                    }
                    else{
                ...
                if ($i>34 && $i<51 && strtoupper($subject) ==="BOTANY"){
                    ...
                    if ($student_ans === "BLANK" || $student_ans === "ABSENT"){
                ...
                elseif ($i>84 && $i<101 && strtoupper($subject) ==="ZOOLOGY"){
                ...
                elseif($i>134 && $i<151 && strtoupper($subject) === "PHYSICS") {
                    //echo "<pre>";
                ...
                elseif ($i>184 && $i<201 && strtoupper($subject) === "CHEMISTRY"){
