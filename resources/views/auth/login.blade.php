                ...
                <div class="form-content">
                    ...
                    <ul>
                        @foreach($errors->all() as $e)
                            <li><div class="alert alert-danger mb-4" role="alert">
                                    ...
                                    </button> <strong>Error</strong> {{$e}}</div></li>
                        @endforeach
                    </ul>
                    ...
                    @if(Session::has('success'))
                        ...
                        </button> {{ Session::get('success') }}</div></p>
                    @endif
                    ...
                    @if(Session::has('error'))
                        <div class="alert alert-danger mb-4" role="alert">
                            ...
                            </button> {{ Session::get('error') }}</div></p>
                    @endif
                    ...
                    <form class="text-left" action="{{url('login')}}" method="post">
                        ...
                        <div class="form">
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="username" name="username" type="email" class="form-control" placeholder="e.g ankit.mathur@motion.ac.in">
                            </div>
