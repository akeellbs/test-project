            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-one">
                    <div class="widget-heading text-center">
                        <h6 class="">Neet New Result File Upload | OMR Data Upload Panel</h6>
                    </div>
                    <form action="{{url('result-uploader/4')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="test_quiz_type" name="test_quiz_type" value="NEET NEW" readonly style="text-transform:uppercase">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" mt-1">
                                        <span class="badge badge-primary">
                                            <small id="sh-text1" class="form-text mt-0">Please enter the multiple of 4</small>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Total Questions (Botany without optionals)</label>
                                    <input type="text" class="form-control" id="test_total_questions_botany" name="test_total_questions_botany" value="0" readonly>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Total Questions (Zoology without optionals)</label>
                                    <input type="text" class="form-control" id="test_total_questions_zoology" name="test_total_questions_zoology" value="0" readonly>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary" style="margin-top: 5%;">
                                        <input type="checkbox" class="new-control-input" id="checkbox" checked>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12" id="optional_view">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Optional Questions(3 Digits max)</label>
                                        <input type="text" class="form-control" id="test_optional_questions" name="test_optional_questions" value="" oninput="set_optional_question_settings()" maxlength="3" pattern="\d*">
                                        <div class=" mt-1">
                                            <span class="badge badge-primary">
                                                <small id="sh-text2" class="form-text mt-0">Please enter the multiple of 4</small>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12" id="optional_view_final_check">
                                <div class="form-group">
                                    ...
                                    <select class="form-control  basic" id="test_question_attempt" name="test_question_attempt">
                                        ...
                                        <option value="1/3">Optional Questions</option>
                                    </select>
                                </div>
                            ...
                            <div id="hidden-view" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-13 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Optional Questions (Botany)</label>
                                            <input type="text" class="form-control" id="test_optional_questions_botany" name="test_total_questions_botany" value="0" readonly>
                                        </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-13 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Optional Questions (Zoology)</label>
                                            <input type="text" class="form-control" id="test_optional_questions_zoology" name="test_total_questions_zoology" value="0" readonly>
                                        </div>
...
@section('page_js')
    ...
    <script>
        ...
        function set_optional_question_settings(){
            ...
            if (parseInt(total_questions) % 4===0){

                $("#sh-text2").html("Please check questions in physics, chemistry and maths")

                let phy  = ((1/4) * parseInt(total_questions));
                let chem = ((1/4) * parseInt(total_questions));
                let bot  = ((1/4) * parseInt(total_questions));
                let zoo  = ((1/4) * parseInt(total_questions));


                $("#test_optional_questions_phy").val(phy)
                $("#test_optional_questions_chem").val(chem)
                $("#test_optional_questions_botany").val(bot)
                $("#test_optional_questions_zoology").val(zoo)
                ...
                $("#test_optional_questions_botany").val("0")
                $("#test_optional_questions_zoology").val("0")
                $("#sh-text2").html("Please enter a digit of multiple 4")
        ...
        function set_question_settings(){
                ...
                if (parseInt(total_questions) % 4===0){
                    ...
                    $("#sh-text1").html("Please check questions in physics, chemistry, botany and zoology")
                    ...
                    $("#test_total_questions_botany").val(bot)
                    $("#test_total_questions_zoology").val(zoo)
                    ...
                    $("#test_total_questions_botany").val("0")
                    $("#test_total_questions_zoology").val("0")
                    $("#sh-text1").html("Please enter a digit of multiple 4")
